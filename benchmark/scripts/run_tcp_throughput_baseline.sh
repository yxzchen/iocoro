...
exec "$SCRIPT_DIR/run_ratio_baseline_suite.sh" \
  ...
  --usage-name "benchmark/scripts/run_tcp_throughput_baseline.sh" \
  ...
  --baseline-description "Threshold file format: \"sessions bytes_per_session chunk_bytes min_ratio\"" \
