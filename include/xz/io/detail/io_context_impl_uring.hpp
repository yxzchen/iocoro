...
/// io_uring-based io_context implementation
class io_context_impl_uring final : public io_context_impl_base {
 public:
  io_context_impl_uring();
  ~io_context_impl_uring() override;
  ...
  auto native_handle() const noexcept -> int override { return ring_.ring_fd; }
 ...
 private:
  ...
  void submit_nop();  // Used to wake up the ring
